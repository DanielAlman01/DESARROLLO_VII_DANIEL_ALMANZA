...
$misAmigos = ["Daniel", "Kevin", "Mark"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Daniel", "David"); // Reemplaza las comillas vacías con los nombres de tus amigos
