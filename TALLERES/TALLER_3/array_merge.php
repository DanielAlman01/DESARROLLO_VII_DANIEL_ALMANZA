...
$misComidas = ["Lazaña", "Pizza", "Hambuerguesa"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "sushi", "Hot dog"]; // Reemplaza con las comidas favoritas de tu amigo
