...
$miArray = ["Daniel", "David", "Itzel", "Raul"]; // Reemplaza esto con tu propio array
$miString = "Desarrolo de Software"; // Reemplaza esto con tu propio string
$miNumero = 07; // Reemplaza esto con tu propio número
