...
function productoMayorValor($inv) {
    ...
    return [
        ...
        "valor_total" => $mayorValor
    ];
}

$resultadoMayorValor = productoMayorValor($inventario);
echo "<br><br> Producto con el mayor valor total en inventario:\n<br>";
echo "Producto: " . $resultadoMayorValor['producto'] . "\n<br>";
echo "Cantidad: " . $resultadoMayorValor['cantidad'] . " unidades\n<br>";
echo "Precio: $" . $resultadoMayorValor['precio'] . "\n<br>";
echo "Valor total: $" . $resultadoMayorValor['valor_total'] . "\n";
