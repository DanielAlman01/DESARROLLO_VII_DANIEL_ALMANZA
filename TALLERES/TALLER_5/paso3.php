...
// Función para encontrar estudiantes que necesitan tutoría (promedio < 75)
...
// Función para encontrar estudiantes de honor (promedio >= 90)
...
if (count($estudiantesTutoria) > 0) {
    ...
    echo "<br>Ningún estudiante necesita tutoría.\n";
}
...
if (count($estudiantesHonor) > 0) {
    ...
    echo "<br>Ningún estudiante es de honor.\n";
}
